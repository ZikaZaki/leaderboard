...
```
$ git clone https://github.com/ZikaZaki/leaderboard.git
```

- Once finished you should see a new folder called **Leaderboard** in your current directory.
- Start customizing the project so it fits your personal preferences and needs.
- Enjoy your new professional **Leaderboard** application!
